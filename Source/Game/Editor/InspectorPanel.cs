...
public class InspectorPanel : ContainerControl
{
    ...
    public InspectorPanel() : base()
    {
        ...
        string[] tabs =
            [
            "\\BlendIcons\\outliner.flax",
            "\\BlendIcons\\outliner_data_light.flax",
            "\\BlendIcons\\outliner_ob_group_instance.flax",
            "\\BlendIcons\\file_folder.flax"
            ];
        ...
        PackingTab.BuildUI(TabPanels[2]);
        SettingsTab.BuildUI(TabPanels[3]);
    }
}